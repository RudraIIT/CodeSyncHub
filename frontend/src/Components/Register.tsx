    ...
    <div className="flex flex-col justify-between bg-[#0E0E10] h-lvh w-lvw p-0 m-0">
        ...
        <div className="flex flex-row w-lvw justify-around items-center z-10" style={{height:'92%'}}>
            ...
            <div className="flex flex-col items-center justify-center bg-[#1d1c20] h-4/5 rounded-2xl w-2/5 space-y-4">
                <h1 className="text-white text-xl">Create a Codesync account</h1>
                ...
                <button className="flex border-white bg-blue-500 pl-9 pr-9 py-2  rounded-xl items-center"><h1 className="text-white">Create Account</h1></button>
                <div className="h-0.5 bg-[#292E3E] w-2/6"></div>
                <div className="flex flex-row items-center space-x-2"><h6 className="text-gray-400">Already have an account?</h6><button onClick={loginOnclickHandler}><h6 className="text-blue-500 text-sm">Log in</h6></button></div>
